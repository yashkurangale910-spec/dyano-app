            ...
            <header className="flex justify-between items-end mb-16 px-4">
                <div className="text-left">
                    ...
                    <div className="text-4xl font-display font-bold text-white tracking-tighter">
                        ...
                        <span className="text-white/20 font-light ml-4">/ {totalIndex}</span>
                    </div>
                </div>

                <div className="text-right pb-1">
                    <div className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/30 mb-1">Time Remaining</div>
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    <LuxuryCard variant="glass">
                        <LuxuryContent className="p-12 mb-12">
